...
const Onboarding = (() => {
  ...
  const steps = [
    ...
    { sel: '#progressionBuilder', pad: 8, interactive: true,
      ...
      body:  { en: 'Your chords land here on a grid. Drag to move them, hold one to lift it, drag an edge to set its length — then hit Play.',
               es: 'Tus acordes caen aquí en un grid. Arrastra para moverlos, mantén pulsado para levantar uno, arrastra un borde para la duración — y pulsa Play.' },
      try:   { en: 'Drag a chord around, then press Play.',
               es: 'Arrastra un acorde y luego pulsa Play.' } },
